...
func NewEventController(cfg *Config) EventController {
	eventController := &eventControllerImpl{
		...
		metricChan: make(chan *metrics_pb.MetricsMessage, 25),
	}
...
type eventControllerImpl struct {
	...
	metricChan chan *metrics_pb.MetricsMessage
	handlers   map[Handler]Handler
}

func (eventController *eventControllerImpl) AcceptMetrics(message *metrics_pb.MetricsMessage) {
